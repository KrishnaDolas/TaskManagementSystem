...
import { Card, TextField, Button, Grid, Autocomplete, TextareaAutosize, Typography, MenuItem } from '@mui/material';
...
const AssignTask = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const newTask = {
      ...
      assignedTo: assignTo, // Include assigned user's value
      status: status,
      priority: priority
    };
